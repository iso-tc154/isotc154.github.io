...
Revision of link:/projects/iso-np-9735-10[ISO 9735-10 -- EDIFACT -- Syntax service directories].
...
Revision of link:/projects/iso-np-17369[ISO/TS 17369 – Statistical data and metadata exchange (SDMX)], as an International Standard (IS).
