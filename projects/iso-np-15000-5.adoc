...
<ul>
<li>The UN/CEFACT Core Component Library (CCL) based on this TS is widely used;</li>
<li>The ISO/TC 154 7372 MA library alignment project has chosen this as the basis for alignment with UN/EDIFACT and UN/CEFACT CCL;</li>
<li>ebMoU Management Team recommends this specification for global semantic harmonization.</li>
</ul>
