...
<h4 id="layout_key_for_trade_documents_8212_part_1_paper_based_documents">Layout key for trade documents &#8212; Part 1: Paper-based documents</h4>
...
<h5 id="revision_information">Revision information</h5>
