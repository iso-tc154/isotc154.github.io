...
order: 9
---
= UN TDED -- ISO 7372 Joint Maintenance Agency (JMA)

== General

UN TDED -- ISO 7372 Joint Maintenance Agency (JMA) was established in the late 80's to maintain the *Trade Data Element Directory* (TDED) issued by UN/ECE as UNTDED and also by ISO/TC154 as ISO 7372.
