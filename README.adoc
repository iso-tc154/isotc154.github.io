...
by using non-breaking space `pass:[&nbsp;]` instead of normal whitespace.
...
The way to solve that is to give hints to the browser as to where whitespace
...
HTML entities such as `pass:[&nbsp;]` are stripped.)
