...
<span style="font-size: 85%;">Address. Address Type *_Code. Code_*
Order Reference. Sales Order *_Identifier. Identifier_*
...
<td style="text-align: center;">XML only (syntax specific)
...
<td style="text-align: center;">Core Component Type
