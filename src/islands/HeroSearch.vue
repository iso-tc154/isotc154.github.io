...
// Astro forwards the page's data-astro-cid-* scope id as a boolean prop; SSR
// renders it as ="true" while the client vnode expects ="", which Vue flags
// as a hydration mismatch. Dropping attr fallthrough fixes both sides.
...
.dark .hero-search__row { border-color: #44403c; background: rgb(15 23 42 / 0.6); }
